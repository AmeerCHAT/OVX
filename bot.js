...
client.on('message', message => {
  ...
  .setFooter(`OVX , Server`, 'https://images-ext-2.discordapp.net/external/X9SanEG0s7Dtv3krTgy-kod_fj6JRVJ2AG4JryCiiz0/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/375761288518828042/fffa31c797e88cf059dd6db424ff456a.png?width=80&height=80')
  .setColor("#000000")
...
//5- عندما يدخل شخص الى سيرفرك يعطيه رتبة ملاحضة: لازم تكون مسوي رتبة اسمها OVX
//6- منع السب
//7- ترحيب على الخاص اسم العضو و رقم العضو 
//8- ارسال رسالة عندما يضيف شخص البوت
...
client.on('guildMemberAdd', member => {
  member.guild.fetchInvites().then(guildInvites => {
    ...
    const stewart = member.guild.channels.find("name", "✨-𝓦𝓔𝓛𝓒𝓞𝓜𝓔-✨");
...
client.on("guildCreate", guild => {
    client.channels.get("522061243448557578").send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
    });
    
    client.on("guildDelete", guild => {
    client.channels.get("522061243448557578").send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
    });
...
client.channels.find('id', '522061782395650048').setName("Welcome To O");
client.channels.find('id', '522061782395650048').setName("Welcome To OV");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX ,");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX , S");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX , Se");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX , Ser");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX , Serv");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX , Serve");
client.channels.find('id', '522061782395650048').setName("Welcome To OVX , Server");
