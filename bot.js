...
client.user.setGame(`!help`,"http://twitch.tv/Nadir44king")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message => {
  ...
  .setFooter(`legend server`, 'https://images-ext-2.discordapp.net/external/X9SanEG0s7Dtv3krTgy-kod_fj6JRVJ2AG4JryCiiz0/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/375761288518828042/fffa31c797e88cf059dd6db424ff456a.png?width=80&height=80')
  .setColor("#000000")
  ...
  **__!avatar__->**يضهر لك صورتك
  ...
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  **__!email__->**يسوي ايميل جميل وهمي
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  ...
  **__!unbanall__->**فك الباند عن الكل
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
  **__!bot list__->**يعرف كم سيرفر متواجد البوت
  -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
...
//1-يمنع الروابط
//2- يمنع النشر
//3- يورجيك اذا كانت شخص مسوي نفسه اوف لاين و يكتب
//4- لما تنمنشن البوت يرد عليك 
//5- عندما يدخل شخص الى سيرفرك يعطيه رتبة ملاحضة: لازم تكون مسوي رتبة اسمها Member
//6- منع السب
//7- ترحيب على الخاص اسم العضو و رقم العضو 
...
client.on('message', message => {
  ...
  const embed = new Discord.RichEmbed()
  .setTitle('Click here')
  .setURL('https://discord.gg/DPXc7gC')
  .setColor('RANDOM')
...
client.on ("guildMemberAdd", member => {
   ...
   var role = member.guild.roles.find ("name", "OVX");
   member.addRole (role);
...
client.on('message', ( message ) => {
  ...
  if(message.channel.id !== '521311672007262211') return;
...
client.on('message', function(message) {
    if (message.channel.type === "dm") {
        ...
        client.channels.get("521721839257387028").send({ embed: stewart });
    }
});
...
client.on("guildCreate", guild => {
    client.channels.get("521721839257387028").send(' ***  BOT  ***   **Join To**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
    });
    
    client.on("guildDelete", guild => {
    client.channels.get("521721839257387028").send(' ***  BOT  ***   **Leave From**   ***[ ' + `${guild.name}` + ' ]***   ,   **  Owner  **  ' + ' ***[ ' + '<@' + `${guild.owner.user.id}` + '>' + ' ]***  **|**  ***[ ' + '<' + `${guild.owner.user.username}` + '>' + ' ]***')
    });
...
setInterval(function(){
client.channels.find('id', '521703890228609025').setName("W");
client.channels.find('id', '521703890228609025').setName("We");
client.channels.find('id', '521703890228609025').setName("Wel");
client.channels.find('id', '521703890228609025').setName("Welc");
client.channels.find('id', '521703890228609025').setName("Welco");
client.channels.find('id', '521703890228609025').setName("Welcom");
client.channels.find('id', '521703890228609025').setName("Welcome");
client.channels.find('id', '521703890228609025').setName("Welcome T");
client.channels.find('id', '521703890228609025').setName("Welcome To");
client.channels.find('id', '521703890228609025').setName("Welcome To O");
client.channels.find('id', '521703890228609025').setName("Welcome To OV");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX ,");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX , S");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX , Se");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX , Ser");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX , Serv");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX , Serve");
client.channels.find('id', '521703890228609025').setName("Welcome To OVX , Server");
...
client.login("NTEwODA0NTY4NTkwNzc4MzY4.DusAuA.zVTx_2zA5EMAZ9iHGmb0vzi2uf0");
